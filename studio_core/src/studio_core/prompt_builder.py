...
_OPTION_BLOCKS: dict[OptionKey, dict[str, str]] = {
    ...
    OptionKey.CLEAN_PART_DIRT: {
        "do": (
            ...
            "следы клея, наклейки магазинов, ценники. Запчасть становится визуально чистой. ВАЖНО: это "
            "касается ТОЛЬКО грязи и наносного — НЕ трогай царапины, вмятины, потёртости, сколы и любые "
            "физические дефекты самой поверхности; они остаются как в исходнике. Заводские маркировки тоже "
            "сохраняются."
        ),
        "skip": (
