...
const OPTIONS: { key: StudioOptionKey; label: string; hint: string }[] = [
  ...
  {
    key: "fix_part_defects",
    label: "Убрать дефекты на детали",
    hint: "Царапины, вмятины, потёртости, сколы — деталь как новая. Грязь не трогаем",
  },
  {
    key: "clean_part_dirt",
    label: "Почистить деталь от грязи",
    hint: "Пыль, смазы, разводы, отпечатки, маслянистые пятна. Дефекты остаются",
  },
  {
    key: "redo_labels",
